...
class DynamicAssetsUtils {
	...
	public static function get_all_canvas_data_for_post( $post_id, $main_content = '' ) {
		...
		// Batch fetch canvas_id, append_to_main, and created_at for all posts in a single query.
		$all_meta           = self::_batch_get_post_meta(
			$canvas_post_ids,
			[ '_divi_canvas_id', '_divi_canvas_append_to_main', '_divi_canvas_created_at' ]
		);
