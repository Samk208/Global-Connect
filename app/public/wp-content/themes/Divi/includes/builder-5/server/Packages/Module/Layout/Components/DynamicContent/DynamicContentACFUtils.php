...
class DynamicContentACFUtils {
	...
	public static function get_repeater_results( array $params ): array {
		...
		$all_repeater_values = self::get_all_repeater_values_from_database( $repeater_field_object, $current_post_id, $repeater_field );
	 ...
	 */
	public static function get_all_repeater_values_from_database( array $repeater_field_object, int $current_post_id = 0, string $full_repeater_name = '' ): array {
		global $wpdb;
